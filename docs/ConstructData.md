...
**aspect** | **float** | Aspect ratio of the Construct output | [optional] 
**uuid** | [**Uuid**](Uuid.md) |  | 
**audio** | [**ConstructDataAudio**](ConstructDataAudio.md) |  | [optional] 
**slots** | [**list[SlotData]**](SlotData.md) | List of Slots of the Construct (only included with level set to ALL) | [optional] 
